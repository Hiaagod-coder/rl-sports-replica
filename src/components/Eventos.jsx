import { Map, Trophy, Mountain } from 'lucide-react';
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {distances.map((dist) => (
            <div key={dist.label} className={`relative group`}>
              ...
              <div className="relative bg-[#0B1120] px-6 py-4 rounded-xl flex items-center justify-center border border-white/10 cursor-default">
